...
function FileUploadHandler(file, ui) {
    ...
    function successCallback(data, status, xhr) {
        if(data.error !== undefined) {
            ...
            uploadStatus = FileUploadHandler.Status.SUCCEDED;
    ...
    function init() {
       ...
       errorCallback("", "<p><b>Not an Image!</b></p><p>This application only handles image uploads.</p>",
                    null); 
    }
}
